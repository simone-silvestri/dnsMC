...
void writeT(TempBand *tempBand)
{
	...
	FILE *fp = fopen("tables/planck-mean.txt","wt");
	for (int i=0; i<nT; i++)
		fprintf(fp,"%lf %le %le %le\n",tempBand[i].T,tempBand[i].kPr,tempBand[i].kP,tempBand[i].kM);
	fclose(fp);

	//write down probability table CK
	fp = fopen("tables/prob.txt","wt");
	for (int i=0; i<nT; i++)
	{
	...
	fp = fopen("tables/prob_new2.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<tempBand[i].totbands; j++)
		{
	...
	fp = fopen("tables/wave_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<tempBand[i].totbands; j++)
		{
	...
	fclose(fp);
	fp = fopen("tables/prob_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		int n=0;
		for (int j=0; j<tempBand[i].totbands; j++)
	...
	{
		for (int j=0; j<tempBand[i].totbands; j++)
			sprintf(tempBand[i].narrband[j].file,"tables/NarrBand%d.txt",j);
	}
...
void writeN(TempBand *tempBand)
{
	...
	FILE *fp = fopen("tables/nanofluid/planck-mean.txt","wt");
	for (int i=0; i<nT; i++)
		fprintf(fp,"%lf %le %le\n",tempBand[i].T,tempBand[i].kPr,tempBand[i].kP);
	fclose(fp);

	//write down probability table CK
	fp = fopen("tables/nanofluid/prob.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<tempBand[i].totbands; j++)
		{
	...
	//write down probability table CK new - 2
	fp = fopen("tables/nanofluid/prob_new2.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<tempBand[i].totbands; j++)
		{
...
#if LBL == 1
	//write down probability table LBL
	fp = fopen("tables/nanofluid/wave_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<tempBand[i].totbands; j++)
		{
	...
	fclose(fp);
	fp = fopen("tables/nanofluid/prob_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		int n=0;
		for (int j=0; j<tempBand[i].totbands; j++)
	...
	{
		for (int j=0; j<tempBand[i].totbands; j++)
			sprintf(tempBand[i].narrband[j].file,"tables/nanofluid/NarrBand%d.txt",j);
	}
	for (int j=0; j<tempBand[0].totbands; j++)
	{
		fp = fopen(tempBand[0].narrband[j].file,"wt");
...
{
	//write down plank-mean tables
	FILE *fp = fopen("tables/particles/planck-mean.txt","wt");
	for (int i=0; i<nT; i++)
	...
	//write down probability table CK new - 2
	fp = fopen("tables/particles/prob_new2.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<particles->totbands; j++)
		{
...
void writePbox(PartSpec2 *particles)
{
...
#if LBL == 1
	//write down probability table LBL
	fp = fopen("tables/particles/wave_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		for (int j=0; j<particles->totbands; j++)
		{
	...
	fclose(fp);
	fp = fopen("tables/particles/prob_lbl.txt","wt");
	for (int i=0; i<nT; i++)
	{
		int n=0;
		for (int j=0; j<particles->totbands; j++)
...
{
	sprintf(phi->writefile,"tables/particles/prob_scatt.txt");
